<div class="ccl-c-promo ccl-c-promo--carousel">
    ...
    <header class="ccl-c-promo__header">
        ...
        <div class="ccl-c-promo__action">
            <button id="carousel-1-prev" class="ccl-c-carousel-arrow prev" aria-label="previous slide">&larr;</button>
            <button id="carousel-1-next" class="ccl-c-carousel-arrow next" aria-label="next slide">&rarr;</button>
        </div>
    </header>
            ...
            do { ?>
                <article class="ccl-c-carousel__slide">
                    <a href="#">
                        ...
                        <p class="ccl-h4 ccl-u-faded ccl-u-mt-0">March 25, 7:00pm</p>
                        <p class="ccl-h4 ccl-u-faded ccl-u-mt-0">Auditorium, Honnold/Mudd Library</p>
                    </a>
                </article>
            <?php $i++; } while ( $i < 8 ); ?>
